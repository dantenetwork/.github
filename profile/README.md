...
We persist in building Dante Protocol in an absolutely open and decentralized way, based on which interaction between isolated heterogeneous consensus spaces can get a **determined** security guarantee. Yes the security can be **determined**.   
